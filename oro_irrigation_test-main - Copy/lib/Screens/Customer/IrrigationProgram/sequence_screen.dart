...
class _SequenceScreenState extends State<SequenceScreen> {
                                                        ...
                                                        trailing: IconButton(
                                                            onPressed: (){
                                                              ...
                                                              showDialog(
                                                                ...
                                                                builder: (context) {
                                                                  return StatefulBuilder(
                                                                      builder: (BuildContext context, StateSetter stateSetter1) {
                                                                        return AlertDialog(
  ...
  Widget buildValveContainer({context, item, isGroup, dataList, lineIndex, bool isMainValve = false}) {
    ...
    final indexToShow = irrigationProgramProvider.addNew
        ...
        ? irrigationProgramProvider.currentIndex+1
        : irrigationProgramProvider.currentIndex;
    // print('irrigationProgramProvider.addNew ${irrigationProgramProvider.addNew}');
    // print('irrigationProgramProvider.addNext ${irrigationProgramProvider.addNext}');
    // print('indexToShow ${indexToShow}');
    // print('irrigationProgramProvider.currentIndex ${irrigationProgramProvider.currentIndex}');
    // print('irrigationProgramProvider.irrigationLine!.sequence ${irrigationProgramProvider.irrigationLine!.sequence}');
    return buildListOfContainer(
        ...
        onTap: (){
          ...
          //   });
          //   print(dataList[indexToShow]);
          //   // irrigationProgramProvider.updateIsGroupSelected(index: index);
          // }
          ...
          // print(irrigationProgramProvider.irrigationLine!.sequence);
        },
        containerColor: isGroup
            ? item.selected ? const Color(0xfffdce7f) : const Color(0xffFFF7E5)
            : !isMainValve
