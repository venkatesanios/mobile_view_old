...
class IrrigationLog {
  ...
  dynamic toJson(){
    ...
    for(var i in prePostParameterList){
      print('prePostParameterList : ${prePostParameterList}');
      print(serverData);
  ...
  void editParameterList({
    required generalParameterListDuplicate,
    required waterParameterListDuplicate,
    required prePostParameterListDuplicate,
    required centralEcPhParameterListDuplicate,
    required centralChannel1ParameterListDuplicate,
    required centralChannel2ParameterListDuplicate,
    required centralChannel3ParameterListDuplicate,
    required centralChannel4ParameterListDuplicate,
    required centralChannel5ParameterListDuplicate,
    required centralChannel6ParameterListDuplicate,
    required centralChannel7ParameterListDuplicate,
    required centralChannel8ParameterListDuplicate,
    required localEcPhParameterListDuplicate,
    required localChannel1ParameterListDuplicate,
    required localChannel2ParameterListDuplicate,
    required localChannel3ParameterListDuplicate,
    required localChannel4ParameterListDuplicate,
    required localChannel5ParameterListDuplicate,
    required localChannel6ParameterListDuplicate,
    required localChannel7ParameterListDuplicate,
    required localChannel8ParameterListDuplicate,
  }){
    generalParameterList = generalParameterListDuplicate;
    waterParameterList = waterParameterListDuplicate;
    prePostParameterList = prePostParameterListDuplicate;
    centralEcPhParameterList = centralEcPhParameterListDuplicate;
    centralChannel1ParameterList = centralChannel1ParameterListDuplicate;
    centralChannel2ParameterList = centralChannel2ParameterListDuplicate;
    centralChannel3ParameterList = centralChannel3ParameterListDuplicate;
    centralChannel4ParameterList = centralChannel4ParameterListDuplicate;
    centralChannel5ParameterList = centralChannel5ParameterListDuplicate;
    centralChannel6ParameterList = centralChannel6ParameterListDuplicate;
    centralChannel7ParameterList = centralChannel7ParameterListDuplicate;
    centralChannel8ParameterList = centralChannel8ParameterListDuplicate;
    localEcPhParameterList = localEcPhParameterListDuplicate;
    localChannel1ParameterList = localChannel1ParameterListDuplicate;
    localChannel2ParameterList = localChannel2ParameterListDuplicate;
    localChannel3ParameterList = localChannel3ParameterListDuplicate;
    localChannel4ParameterList = localChannel4ParameterListDuplicate;
    localChannel5ParameterList = localChannel5ParameterListDuplicate;
    localChannel6ParameterList = localChannel6ParameterListDuplicate;
    localChannel7ParameterList = localChannel7ParameterListDuplicate;
    localChannel8ParameterList = localChannel8ParameterListDuplicate;
  }
          ...
          if(parameter.show == true){
            ...
            if(data == null || data == ''){
              ...
              if(data.contains('_')){
                ...
                if(splitData[channelNo] == null){
                  list.add(null);
                }else{
                  list.add(splitData[channelNo]);
                }
                print('liiii : $list   ${splitData[channelNo]}');
              }else{
                list.add(null);
              }
            }
...
class GraphData{
  final dynamic plannedLow;
  final dynamic plannedHigh;
  final dynamic actualLow;
  final dynamic actualHigh;
  final String seqName;
  GraphData({required this.actualLow,required this.actualHigh,required this.plannedLow,required this.plannedHigh,required this.seqName});
}


GraphData getGraphData({required method,required planned,required actualDuration,required actualLiters,required flowRate,required String name}){
  if(method == 1){
    var plannedSeconds = DataConvert().parseTimeString(planned);
    var actualSeconds = DataConvert().parseTimeString(actualDuration);
    var flowRateForPerSec = flowRate/3600;
    var plannedLiters = plannedSeconds * flowRateForPerSec;
    var actualLiters = actualSeconds * flowRateForPerSec;
    GraphData dataToAdd = GraphData(actualLow: 0,actualHigh: actualLiters, plannedLow: actualLiters,plannedHigh: plannedLiters, seqName: name);
    return dataToAdd;
  }else{
    GraphData dataToAdd = GraphData(actualLow: 0,actualHigh: actualLiters, plannedLow: actualLiters,plannedHigh: int.parse(planned), seqName: name);
    return dataToAdd;
  }
